import initialStateBannersEn from "../base/translation-texts/Banners-en";
...
const initialState = {
    ...
    bannersEn: initialStateBannersEn
}
...
export const getBannersEnSelector = (state) => state.languageReducer.bannersEn;